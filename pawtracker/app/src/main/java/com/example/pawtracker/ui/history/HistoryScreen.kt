...
fun HistoryScreen(
    ...
    Box(
        ...
        Column(
            modifier = Modifier
                .fillMaxHeight()
                .widthIn(max = if (navigationType != NavigationType.BOTTOM_NAVIGATION) 840.dp else Dp.Unspecified)
    ...
    fun WalkHistoryItem(walk: WalkUiModel) {
        ...
        val distanceFormatted =
            stringResource(R.string.history_item_distance_label, walk.distanceKm)
        ...
        Column(
            ...
            Text(
                text = stringResource(
                    R.string.history_item_combined_label,
                    distanceFormatted,
                    timeFormatted
                ),
            )
