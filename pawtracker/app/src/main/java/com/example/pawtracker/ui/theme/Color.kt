...
// Light Theme Colors
val md_theme_light_primary = Color(0xFF13068B)
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFE1ECFE)
val md_theme_light_onPrimaryContainer = Color(0xFF13068B)

val md_theme_light_secondary = Color(0xFF5D5E7E)
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFE2E0F9)
val md_theme_light_onSecondaryContainer = Color(0xFF1A1B33)

val md_theme_light_tertiary = Color(0xFF7C4F9A)
val md_theme_light_onTertiary = Color(0xFFFFFFFF)
val md_theme_light_tertiaryContainer = Color(0xFFF4DAFF)
val md_theme_light_onTertiaryContainer = Color(0xFF33004F)
...
val md_theme_light_background = Color(0xFFE1ECFE)
...
val md_theme_dark_onPrimary = Color(0xFF13068B)
val md_theme_dark_primaryContainer = Color(0xFF2E2A9E)
val md_theme_dark_onPrimaryContainer = Color(0xFFE1ECFE)

val md_theme_dark_secondary = Color(0xFFC6C4DD)
val md_theme_dark_onSecondary = Color(0xFF2F3048)
val md_theme_dark_secondaryContainer = Color(0xFF464760)
val md_theme_dark_onSecondaryContainer = Color(0xFFE2E0F9)

val md_theme_dark_tertiary = Color(0xFFE4B6FF)
val md_theme_dark_onTertiary = Color(0xFF4A1766)
val md_theme_dark_tertiaryContainer = Color(0xFF633380)
...
val md_theme_dark_inversePrimary = Color(0xFF13068B)
